...
/* =========================================================
   ...
   IMPORTANT:
   The existing database uses products.img.
   DO NOT use products.image in SQL queries.
========================================================= */
...
async function initDatabase() {
  ...
  /*
    Existing database already has "img".
    This makes sure a fresh database also gets "img".
  */
  await pool.query(`
